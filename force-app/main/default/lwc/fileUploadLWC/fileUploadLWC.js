...
export default class fileUploadLWC extends LightningElement {
    ...
    connectedCallback() {
        //registerListener("keydown", this.checkKeypress, this);
        // registerListener('keydown', this.checkKeypress, this);
        window.addEventListener('keyup', this.checkKeypress.bind(this), false);
        // registerli
    }
    ...
    handleSelectedFiles(event) {
        if (event.target.files.length > 0) {
           ...
           // this.getMIMEType(this.fileName.substr((this.fileName.lastIndexOf('.') + 1)));
           // this.selectedFilesToUpload[0].type = this.fileType;
    ...
    checkKeypress(key) {
        ...
        if (key.keyCode == '65') {
            alert('The a letter key has been pressed new');
            this.welcomeMessage();
        }
    }
    welcomeMessage() {
        console.log('Congratualtios..............');
    }
}